...
- resource.aws_iam_role.ebs_csi (/terraform-docs/main.tf#583)
- resource.aws_iam_role_policy_attachment.ai_models__eks_access (/terraform-docs/main.tf#606)
- resource.aws_iam_role_policy_attachment.backups__eks_access (/terraform-docs/main.tf#614)
- resource.aws_iam_role_policy_attachment.ebs_csi_attach (/terraform-docs/main.tf#596)
- resource.aws_s3_bucket.ai_models (/terraform-docs/main.tf#602)
- resource.aws_s3_bucket.backups (/terraform-docs/main.tf#610)
...
- resource.aws_secretsmanager_secret.google_sso_credentials (/terraform-docs/main.tf#560)
- resource.aws_secretsmanager_secret.nebuly_credentials (/terraform-docs/main.tf#524)
- resource.aws_secretsmanager_secret.okta_sso_credentials (/terraform-docs/main.tf#540)
...
- resource.aws_secretsmanager_secret_version.google_sso_credentials (/terraform-docs/main.tf#569)
- resource.aws_secretsmanager_secret_version.nebuly_credentials (/terraform-docs/main.tf#531)
- resource.aws_secretsmanager_secret_version.okta_sso_credentials (/terraform-docs/main.tf#549)
