...
- resource.aws_iam_role_policy_attachment.ai_models__eks_access (/terraform-docs/main.tf#545)
- resource.aws_iam_role_policy_attachment.backups__eks_access (/terraform-docs/main.tf#553)
- resource.aws_s3_bucket.ai_models (/terraform-docs/main.tf#541)
- resource.aws_s3_bucket.backups (/terraform-docs/main.tf#549)
...
- resource.aws_secretsmanager_secret.google_sso_credentials (/terraform-docs/main.tf#517)
...
- resource.aws_secretsmanager_secret_version.google_sso_credentials (/terraform-docs/main.tf#526)
