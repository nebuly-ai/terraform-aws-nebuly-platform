...
- resource.aws_iam_role.ebs_csi (/terraform-docs/main.tf#603)
- resource.aws_iam_role_policy_attachment.ai_models__eks_access (/terraform-docs/main.tf#626)
- resource.aws_iam_role_policy_attachment.backups__eks_access (/terraform-docs/main.tf#634)
- resource.aws_iam_role_policy_attachment.ebs_csi_attach (/terraform-docs/main.tf#616)
- resource.aws_s3_bucket.ai_models (/terraform-docs/main.tf#622)
- resource.aws_s3_bucket.backups (/terraform-docs/main.tf#630)
...
- resource.aws_secretsmanager_secret.google_sso_credentials (/terraform-docs/main.tf#580)
- resource.aws_secretsmanager_secret.microsoft_sso_credentials (/terraform-docs/main.tf#540)
- resource.aws_secretsmanager_secret.nebuly_credentials (/terraform-docs/main.tf#524)
- resource.aws_secretsmanager_secret.okta_sso_credentials (/terraform-docs/main.tf#560)
- resource.aws_secretsmanager_secret.openai_api_key (/terraform-docs/main.tf#511)
...
- resource.aws_secretsmanager_secret_version.google_sso_credentials (/terraform-docs/main.tf#589)
- resource.aws_secretsmanager_secret_version.microsoft_sso_credentials (/terraform-docs/main.tf#549)
- resource.aws_secretsmanager_secret_version.nebuly_credentials (/terraform-docs/main.tf#531)
- resource.aws_secretsmanager_secret_version.okta_sso_credentials (/terraform-docs/main.tf#569)
- resource.aws_secretsmanager_secret_version.openai_api_key (/terraform-docs/main.tf#519)
